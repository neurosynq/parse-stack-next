...
class WebhookTriggersTest < Minitest::Test
  ...
  def test_before_save_trigger
    ...
    Parse::Webhooks.call_route(:before_save, "TestObject", client_payload)
  ...
  def test_after_save_trigger
    ...
    Parse::Webhooks.call_route(:after_save, "TestObject", client_payload)
  ...
  def test_before_delete_trigger
    ...
    Parse::Webhooks.call_route(:before_delete, "TestObject", client_payload)
  ...
  def test_after_delete_trigger
    ...
    client_payload = Parse::Webhooks::Payload.new(client_payload_data)
    Parse::Webhooks.call_route(:after_delete, "TestObject", client_payload)
  ...
  def test_before_find_trigger
    ...
    Parse::Webhooks.call_route(:before_find, "TestObject", client_payload)
  ...
  def test_after_find_trigger
    ...
    Parse::Webhooks.call_route(:after_find, "TestObject", client_payload)
  ...
  def test_multiple_trigger_hooks
    ...
    Parse::Webhooks.call_route(:before_save, "TestObject", before_payload)
  ...
  def test_wildcard_trigger_routing
    ...
    Parse::Webhooks.call_route(:after_save, "TestObject", payload)
    ...
    Parse::Webhooks.call_route(:after_save, "*", unknown_payload)
