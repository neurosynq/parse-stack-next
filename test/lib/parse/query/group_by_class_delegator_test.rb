...
# correct types without making any network calls. The live-server companion
# lives in group_by_class_delegator_integration_test.rb so this file stays
# Docker-free and runs in the unit suite (rake test:unit).
