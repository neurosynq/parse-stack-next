...
class TestDoesNotMatchKeyInQueryConstraint < Minitest::Test
  extend Minitest::Spec::DSL
  include ConstraintTests

  def setup
    @klass = Parse::Constraint::DoesNotMatchKeyInQueryConstraint
    @key = :$dontSelect
    @operand = :does_not_match_key_in_query
    @keys = [:does_not_match_key, :does_not_match_key_in_query]
